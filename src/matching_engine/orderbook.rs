...
pub struct Orderbook{
    asks: HashMap<Decimal, Limit>, // price: Limit Order
...
impl Orderbook {
    ...
    // check if limits are crossing the spread, then fill market
    ...
    pub fn fill_market_order(&mut self, market_order: &mut Order) { 
        // TODO: return Vec of matches
        // keep track how much is matched
    ...
    // SORTING: ASKS -> shorted cheapest price
    ...
    // SORTING: BIDS -> sorted highest price
...
impl Limit{
    ...
    fn fill_order(&mut self, market_order: &mut Order) {
        for limit_order in self.orders.iter_mut() {
            ...
            if market_order.is_filled() {break;}
        }
    }
...
pub mod tests {
    ...
    fn orderbook_fill_market_order_ask() {
        ...
        let mut market_order = Order::new(BidOrAsk::Bid, 15.0);
